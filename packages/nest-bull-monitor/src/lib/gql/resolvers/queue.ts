...
import type { Queue as GqlQueue, QueueMetrics as GqlQueueMetrics } from '../../typings/gql';
...
export const queueResolver: TResolvers = {
    Queue: {
        ...
        async metrics(parent: Queue, _, { dataSources: { metrics } }): Promise<GqlQueueMetrics[]> {
