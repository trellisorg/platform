import type { QueryJobArgs, QueryMetricsArgs, QueryQueueArgs } from '../../typings/gql';
...
export const queryResolver: TResolvers = {
    Query: {
        ...
        async metrics(_, args: QueryMetricsArgs, { dataSources: { metrics } }) {
            return await metrics.getMetrics(args.queue, args.start as number, args.end as number);
        },
